...
const FAQS = [
  ...
  },
  {
    ...
    answer: "Once your deals are verified, your Sephora voucher code will be delivered to your email within 24\u201348 hours."
  }
];
    ...
    <>
      ...
      <main className="flex-1 flex flex-col items-center w-full max-w-[400px] mx-auto px-4 pt-6 pb-8">
        ...
        <div className="h-[56px] mb-5 mt-1 flex justify-center items-center w-full">
          <img
            src="https://upload.wikimedia.org/wikipedia/commons/2/21/Sephora_logo.svg"
            alt="Sephora"
        ...
        <p className="text-gray-600 text-center mb-6 text-[13px]">
          Claim your <span className="font-bold text-black">$750</span> Sephora voucher
        </p>
        ...
        {/* CTA */}
        <button 
           onClick={() => window.location.href = 'https://trksy.org/aff_c?offer_id=1185&aff_id=144760'}
